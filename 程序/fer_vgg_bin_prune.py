...
from models import vgg_bin_prune
...
parser.add_argument('--epochs', type=int, default=300, metavar='N',help='number of epochs to train (default: 250)')
...
learning_rate_decay_start = 130  # 50
...
if opt.refine:
    ...
    net = vgg_bin_prune.VGG(cfg=checkpoint['cfg'])
    ...
    checkpoint = torch.load('prune_models/fer_Pri_vgg16_bin.pth')
...
optimizer = optim.SGD(net.parameters(), lr=opt.lr, momentum=0.9, weight_decay= 6e-4)
...
def PublicTest(epoch):
    ...
    if PublicTest_acc > best_PublicTest_acc:
        ...
        torch.save(state, 'prune_models/fer_Pub_vgg16_bin.pth')
        best_PublicTest_acc = PublicTest_acc
...
def PrivateTest(epoch):
    ...
    if PrivateTest_acc > best_PrivateTest_acc:
        ...
        torch.save(state,'prune_models/fer_Pri_vgg16_bin.pth')
        best_PrivateTest_acc = PrivateTest_acc
        best_PrivateTest_acc_epoch = epoch
